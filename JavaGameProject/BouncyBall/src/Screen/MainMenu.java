...
//      introMusic.start(); // 배경음 On
      ...
      exit = new MyButton("Button\\exit_Button", 300, 100); exit.setLocation(900, 300);
      ...
      add(back); add(scroll);
      add(exit); add(cooperation); 
      add(pvp);  add(game_back);
      add(p1);
   ...
   public void actionPerformed(ActionEvent e) {
      if (e.getSource() == play) {
         ...
         ranking.setVisible(false); play.setVisible(false); 
         ...
         play.setVisible(false); exit.setVisible(false);
      }
...
//         introMusic.close();
         ...
         play.setVisible(true); exit.setVisible(true);
         back.setVisible(false); scroll.setVisible(false); 
         cooperation.setVisible(false); pvp.setVisible(false); 
      }
   }
